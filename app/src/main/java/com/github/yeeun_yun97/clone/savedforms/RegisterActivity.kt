...
class RegisterActivity : AppCompatActivity() {
    private val submitButton by lazy { findViewById<Button>(R.id.RegisterActivity_submitButton) }
    private val emailDuplicateCheckButton by lazy { findViewById<Button>(R.id.RegisterActivity_emailDuplicateCheckButton) }
    private val emailEditText by lazy { findViewById<EditText>(R.id.RegisterActivity_emailEditText) }
    private val emailCheckedTextview by lazy { findViewById<TextView>(R.id.RegisterActivity_emailCheckedTextview) }
